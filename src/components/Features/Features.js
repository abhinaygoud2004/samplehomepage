      ...
      <div className="flex-1 col-md-6 mt-5 order-md-1 order-2">
        <div>
          ...
          <h2
            ...
            Top Features that keep us ahead
          </h2>
        </div>
        <div className="d-md-flex flex-md-row flex-column mb-4">
          <div className="col-md-12">
            Lorem ipsum dolor sit amet consectetur adipisicing elit. Nostrum
            modi exercitationem, eaque aut nisi saepe sapiente nihil dolores
            optio maxime.
          </div>
        </div>
        <div className="d-md-flex flex-md-row flex-column">
          <div className="col-md-6 mb-md-0 mb-4">
            ...
            exercitationem officiis in aut excepturi iure? Sint ab voluptas ex
            reiciendis?
          </div>
